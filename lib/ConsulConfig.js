...
class ConsulConfig extends AbstractConfig {
     ...
     * @param {String} option.pathPerfix The perfix of consul key element.
     */
    constructor(option) {
        ...
        this._pathPerfix = option.pathPerfix || '';
    }
    /**
     * @override
     * @private
     ...
     */
    _loadVar(key) {
        const promise = this._consul.kv.get(this._pathPerfix + key);
