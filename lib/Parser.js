 ...
 * 
 * @property {*} [preferredValue] when it not empty , it will be used instead of the value get from consul or json object.
...
class Parser {
    ...
    doParseElement({key, value, isFromWatch=false, oldValue}) {
        ...
        if (!this._isEmptyValue(schemaElement.preferredValue)) {
            value = schemaElement.preferredValue;
        }
        if (customValidator) {
